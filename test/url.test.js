  ...
  describe('URL - Node implementation', function() {
    ...
    describe('relative tests', function() {
      /*
       [from, path, expected]
      */
      var relativeTests = mRelativeTests = [
    ...
    describe('Chiron tests', function() {
      //
      ...
      it('should resolve first set as expected', function() {
      ...
      it('should resolve second set as expected', function() {
        //format: [from, path, expected]
        mRelativeTests.forEach(function(relativeTest) {
      ...
      it('should resolve third set as expected', function() {
        relativeTests2.forEach(function(relativeTest) {
